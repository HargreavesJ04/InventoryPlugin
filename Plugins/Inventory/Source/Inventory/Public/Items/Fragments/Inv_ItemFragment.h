...
struct FInv_GridFragment : public FInv_ItemFragment
{
	...
	// This function was missing and caused your build error!
...
{
	GENERATED_BODY()
	virtual void OnConsume(class APlayerController* PC) {}
};
...
{
	GENERATED_BODY()
	virtual void OnConsume(class APlayerController* PC) override;
};
